...
export default function RootLayout({
  ...
  return (
    <main className='font-inter xs:h-auto flex-row- h-dvh min-h-full w-full flex-row-reverse overflow-auto overflow-x-hidden bg-gray p-8 lg:grid lg:grid-cols-2'>
